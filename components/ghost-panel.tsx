            ...
            <AnimatePresence initial={false}>
              {ghostNotes.map((note) => (
                <motion.div
                  ...
                  transition={panelTransition}
                  className="bg-muted/40 border border-border/50 rounded-xl p-4 flex flex-col gap-3"
                >
                  ...
                  {!note.isGenerating &&
                    (note.isError ? (
                      <button
                        ...
                        className="flex items-center gap-1.5 w-full justify-center rounded-lg bg-red-500/10 hover:bg-red-500/20 px-4 py-2 text-xs font-semibold text-red-600 dark:text-red-400 transition-colors"
                      >
                      ...
                      <button
                        ...
                        className="flex items-center gap-1.5 w-full justify-center rounded-lg bg-primary/10 hover:bg-primary/20 px-4 py-2 text-xs font-semibold text-primary transition-colors"
                      >
