 ...
 *   Both are used to distinguish "deleted locally" from "created on another device".
 *   If not provided, deletions are skipped entirely (safe fallback).
 */
async function saveWorkspace(userId, workspace, lastSyncedNoteIds, lastSyncedProjectIds) {
