...
export function exportToMarkdown(projectName: string, blocks: ExportBlock[]): string {
  if (blocks.length === 0) {
    return [
      ...
      ``,
      `---`,
      `*Generated by [FikrPad](https://FikrPad.space)*`,
    ].join("\n")
  }
  ...
  lines.push(`source: FikrPad — https://FikrPad.space`)
  lines.push(`---`)
  lines.push(``)
  ...
  lines.push(``)
  lines.push(`> **Generated by [FikrPad](https://FikrPad.space)** · ${date} · ${blocks.length} node${blocks.length !== 1 ? "s" : ""}`)
  lines.push(``)
  ...
  lines.push(`---`)
  lines.push(``)
  lines.push(`*Generated by [FikrPad](https://FikrPad.space) · ${date}*`)
  lines.push(``)
