...
export function exportToMarkdown(projectName: string, blocks: ExportBlock[]): string {
  if (blocks.length === 0) {
    return [
      ...
      ``,
      `---`,
      `*Generated by [Fikr Studio](https://Fikr Studio.space)*`,
    ].join("\n")
  }
  ...
  lines.push(`source: Fikr Studio — https://Fikr Studio.space`)
  lines.push(`---`)
  lines.push(``)
  ...
  lines.push(``)
  lines.push(`> **Generated by [Fikr Studio](https://Fikr Studio.space)** · ${date} · ${blocks.length} node${blocks.length !== 1 ? "s" : ""}`)
  lines.push(``)
  ...
  lines.push(`---`)
  lines.push(``)
  lines.push(`*Generated by [Fikr Studio](https://Fikr Studio.space) · ${date}*`)
  lines.push(``)
 ...
 */
export function exportSingleBlockToMarkdown(block: ExportBlock): string {
  const lines: string[] = []
